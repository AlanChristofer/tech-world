...
export function DeveloperLab() {
  ...
  return <>
    {(request.isPending || success) && <ol className="lab-runtime-flow" aria-label="Fluxo real da requisição"><li>Frontend</li><li>REST</li><li>Spring Boot</li><li>Use Case</li><li>Port</li><li>Adapter</li><li>MongoDB</li></ol>}
